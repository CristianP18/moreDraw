      ...
      =================================================================== -->
        <q-btn-group unelevated>
            ...
            <q-btn-dropdown
                flat
                icon="place"
                :label="$t('design.icons')"
                no-caps
            >
                <spk-list style="min-width: 200px;">
                    ...
                    >
                        <q-list>
                            ...
                            >
                                ...
                                <spk-item-section>{{ icon.label }}</spk-item-section>
                            </spk-item>
                        </q-list>
                    </q-expansion-item>
...
// Filtro de projetos
const filteredProjects = computed(() => images.value.filter(
...
const availableIcons = [
    { icon: yardIcon, name: 'yard', label: 'Yard', type: 'yard', category: 'infraestrutura' },
    { icon: trailerIcon, name: 'trailer', label: 'Carreta', type: 'trailer', category: 'infraestrutura' },
    { icon: truckIcon, name: 'truck', label: 'Caminhão', type: 'truck', category: 'infraestrutura' },
    { icon: empresaIcon, name: 'empresa', label: 'Empresa', type: 'empresa', category: 'infraestrutura' },

    { icon: treeIcon, name: 'tree', label: 'Árvore', type: 'tree', category: 'natureza' },
    { icon: arbustoIcon, name: 'arbusto', label: 'Arbusto', type: 'arbusto', category: 'natureza' },
    { icon: gramaIcon, name: 'grama', label: 'Grama', type: 'grama', category: 'natureza' },
    { icon: gramadoDarkIcon, name: 'gramadoDark', label: 'Gramado Dark', type: 'gramadoDark', category: 'natureza' },
    { icon: greenGrasIcon, name: 'greenGras', label: 'Green Gras', type: 'greenGras', category: 'natureza' },
    { icon: pastoIcon, name: 'pasto', label: 'Pasto', type: 'pasto', category: 'natureza' },
    { icon: montanhaIcon, name: 'montanha', label: 'Montanha', type: 'montanha', category: 'natureza' },
    { icon: pessegueiroIcon, name: 'pessegueiro', label: 'Pessegueiro', type: 'pessegueiro', category: 'natureza' },
    { icon: savanaIcon, name: 'savana', label: 'Savana', type: 'savana', category: 'natureza' },
    { icon: pond312465Icon, name: 'pond312465', label: 'Lago 312465', type: 'pond312465', category: 'natureza' },
    { icon: pond1346068Icon, name: 'pond1346068', label: 'Lago 1346068', type: 'pond1346068', category: 'natureza' },

    { icon: wallDarkIcon, name: 'wallDark', label: 'Parede Escura', type: 'wallDark', category: 'estruturas' },
    { icon: wallLightIcon, name: 'wallLight', label: 'Parede Clara', type: 'wallLight', category: 'estruturas' },
    { icon: muroIcon, name: 'muro', label: 'Muro', type: 'muro', category: 'estruturas' },
    { icon: predioIcon, name: 'predio', label: 'Prédio', type: 'predio', category: 'estruturas' },
    { icon: telhadoZincoCopiaIcon, name: 'telhadoZincoCopia', label: 'Telhado Zinco Cópia', type: 'telhadoZincoCopia', category: 'estruturas' },
    { icon: telhadoZincoIcon, name: 'telhadoZinco', label: 'Telhado Zinco', type: 'telhadoZinco', category: 'estruturas' },
    { icon: objectRetryProcessedIcon, name: 'objectRetryProcessed', label: 'Objeto Processado', type: 'objectRetryProcessed', category: 'estruturas' },
    { icon: patio02Icon, name: 'patio02', label: 'Pátio 02', type: 'patio02', category: 'estruturas' },
    { icon: vagasIcon, name: 'vagas', label: 'Vagas', type: 'vagas', category: 'estruturas' },
    { icon: vagas02Icon, name: 'vagas02', label: 'Vagas 02', type: 'vagas02', category: 'estruturas' },
    { icon: vagsTrucksLate3ralIcon, name: 'vagsTrucksLate3ral', label: 'Vagas Caminhões Lateral', type: 'vagsTrucksLate3ral', category: 'estruturas' },
    { icon: vagsTrucksIcon, name: 'vagsTrucks', label: 'Vagas Caminhões', type: 'vagsTrucks', category: 'estruturas' },

    { icon: asfaltoVerticalIcon, name: 'asfaltoVertical', label: 'Asfalto Vertical', type: 'asfaltoVertical', category: 'pavimentacao' },
    { icon: asfaltoIcon, name: 'asfalto', label: 'Asfalto', type: 'asfalto', category: 'pavimentacao' },
    { icon: calcadaHorizontalIcon, name: 'calcadaHorizontal', label: 'Calçada Horizontal', type: 'calcadaHorizontal', category: 'pavimentacao' },
    { icon: calcadaIcon, name: 'calcada', label: 'Calçada', type: 'calcada', category: 'pavimentacao' },
    { icon: canteiroHorizontalIcon, name: 'canteiroHorizontal', label: 'Canteiro Horizontal', type: 'canteiroHorizontal', category: 'pavimentacao' },
    { icon: canteiroIcon, name: 'canteiro', label: 'Canteiro', type: 'canteiro', category: 'pavimentacao' },
    { icon: estradaCinzaIcon, name: 'estradaCinza', label: 'Estrada Cinza', type: 'estradaCinza', category: 'pavimentacao' },
    { icon: estradaIcon, name: 'estrada', label: 'Estrada', type: 'estrada', category: 'pavimentacao' },

    { icon: ceuIcon, name: 'ceu', label: 'Céu', type: 'ceu', category: 'outros' },
    { icon: divisaoVagasIcon, name: 'divisaoVagas', label: 'Divisão de Vagas', type: 'divisaoVagas', category: 'outros' },
    { icon: image2Icon, name: 'image2', label: 'Imagem 2', type: 'image2', category: 'outros' },
    { icon: image3Icon, name: 'image3', label: 'Imagem 3', type: 'image3', category: 'outros' },
    { icon: image720Icon, name: 'image720', label: 'Imagem 720', type: 'image720', category: 'outros' },
    { icon: imageFinalCleaned2Icon, name: 'imageFinalCleaned2', label: 'Imagem Limpa 2', type: 'imageFinalCleaned2', category: 'outros' },
    { icon: paperTextureIcon, name: 'paperTexture', label: 'Textura de Papel', type: 'paperTexture', category: 'outros' },
    { icon: texture1033755Icon, name: 'texture1033755', label: 'Textura 1033755', type: 'texture1033755', category: 'outros' },
    { icon: vehicleNewRetryProcessedIcon, name: 'vehicleNewRetryProcessed', label: 'Veículo Processado', type: 'vehicleNewRetryProcessed', category: 'outros' },
    { icon: yard03Icon, name: 'yard03', label: 'Yard 03', type: 'yard03', category: 'outros' },
];
...
function emitNewProject() {
    ...
    newProjectForm.value = { imageName: '', groupBy: '', description: '', type: '2' };
}
...
function selectDrawingMode(mode) {
  ...
  .spk-item-section:last-child {
    display: flex;
    align-items: center;
  }
  .spk-item-section > span {
    font-size: 14px;
    margin-left: 10px;
  }
